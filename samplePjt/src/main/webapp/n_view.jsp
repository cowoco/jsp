  ...
  <section>
    ...
    <table>
      ...
      <tr>
        ...
        <a href="n_view.do?page=${page}&bno=${nextDto.bno}&category=${category}&sword=${sword}">${nextDto.btitle}</td></a>
      </tr>
      <tr>
        <td><strong>이전글</strong> <span class="separator">|</span>
        <a href="n_view.do?page=${page}&bno=${preDto.bno}&category=${category}&sword=${sword}">${preDto.btitle}</td></a>
      </tr>
    </table>
    ...
    <a href="n_reply.do?page=${page}&bno=${bdto.bno}&category=${category}&sword=${sword}"><div class="list">답글</div></a>
  </section>
  <footer>
    <div class="wrapper">
